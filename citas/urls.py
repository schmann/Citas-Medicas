...
# Importaciones diferidas para evitar problemas de carga de aplicaciones
def get_views():
    from . import views
    ...
    from .views_cita_web import registrar_paciente
    
    return views, {
        'ConsultorioListView': ConsultorioListView,
        'ConsultorioCreateView': ConsultorioCreateView,
        'ConsultorioUpdateView': ConsultorioUpdateView,
        'ConsultorioDetailView': ConsultorioDetailView,
        'ConsultorioDeleteView': ConsultorioDeleteView,
        'toggle_consultorio_status': toggle_consultorio_status,
        'registrar_paciente': registrar_paciente
    }

# Obtener las vistas de manera perezosa
views, view_objects = get_views()

# Hacer que las vistas estén disponibles en el espacio de nombres actual
for name, obj in view_objects.items():
    globals()[name] = obj
...
urlpatterns = [
    ...
    # URLs de la web de citas
    path('registrar/', registrar_paciente, name='registrar_paciente'),
    
    # Otras URLs de la web de citas
    path('', include('citas.urls_cita_web')),
]
